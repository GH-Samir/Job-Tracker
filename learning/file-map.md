...
- app.js — known (2026-08-07) — builds and configures the Express app: middleware, all four CRUD routes, validation guards. Exports the app without starting it, which is what lets tests import it. → [[separation-of-concerns]] [[express]]
...
- **STALE as of 2026-08-07:** db.js, seed.js and every query still use better-sqlite3, while the real database is now Postgres. The code and the database disagree — task 8.3 closes the gap.
